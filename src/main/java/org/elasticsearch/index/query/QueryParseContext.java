...
public class QueryParseContext {
    ...
    public QueryParseContext(Index index, IndexQueryParserService indexQueryParser, boolean neverCache) {
        this.index = index;
        this.indexQueryParser = indexQueryParser;
        this.propagateNoCache = neverCache;
    ...
    public Filter cacheFilter(Filter filter, @Nullable CacheKeyFilter.Key cacheKey) {
        ...
        if (this.neverCache || this.propagateNoCache || filter instanceof NoCacheFilter) {
            return filter;
        }
        if (cacheKey != null) {
