...
/**
 */
public class WeigthedBaseBogusReadersCache extends BaseBogusReadersCache {
    ...
    public void testWeightedFilterCache() throws Exception {
        ...
        try {
            ...
            assertThat(e.getMessage(), equalTo("Can't cache for an index reader with no core closed listener"));
        }
