...
import org.elasticsearch.index.cache.BaseBogusReadersCache;
...
/**
 */
public class FieldDataBaseBogusReadersCache extends BaseBogusReadersCache {
    ...
    public void testFieldDataCache() throws Exception {
        ...
        try {
            ...
            ElasticsearchIllegalArgumentException cause = (ElasticsearchIllegalArgumentException) e.getCause();
            assertThat(cause.getMessage(), equalTo("Can't cache for an index reader with no core closed listener"));
        }
